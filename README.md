...
2. From this repo:
   ...
   That is `expo start --go --clear`. It wipes the Metro cache, prints a QR code, and serves iOS, Android, and web. Confirm you have the latest build on **You → Code Red 1.0.1**.
